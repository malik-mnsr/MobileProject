...
public class DoctorSettings {
    ...
    public DoctorSettings(Integer settingId, Long doctorId, String modePreferences, String notificationPreferences,
                          String emergencyContacts, String awayMessage) {
